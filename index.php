...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:yogessh23@gmail.com">INFO@BAYRESORTS.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9444323200</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">BAY <span>RESORTS</span><p class="logo_w3l_agile_caption">Your Dream Destination</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">BAY RESORTS</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our BAY RESORTS</h3> 
...
<!-- //gallery -->
  ...
  <!-- visitors -->
	<div class="w3l-visitors-agile" >
		<div class="container">
                 <h3 class="title-w3-agileits title-black-wthree">Celebrities Views </h3> 
		</div>
					...
					<ul class="slides">
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5_1.jpg" alt=" " class="img-responsive" />
	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				<h4>Contact Us</h4>
				<p class="contact-agile2">Do Sign Up For Our News Letters</p>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 4444-22-55</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:yogessh23@gmail.com">INFO@BAYRESORTS.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> La Rambla Road, Barcelona, Spain</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 BAY RESORTS . All Rights Reserved | Design by <a href="index.php">BAY RESORTS</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
